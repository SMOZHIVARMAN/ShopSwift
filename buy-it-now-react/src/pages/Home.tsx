...
const Home: React.FC = () => {
  ...
  const bestDeals = products.filter(p => p.originalPrice && p.originalPrice > p.price).slice(0, 4);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Welcome to <span className="text-yellow-400">ShopSwift</span>
            </h1>
            ...
            <Link
              to="/categories"
              className="inline-flex items-center bg-yellow-400 text-gray-900 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-300 transition-colors"
            >
              Start Shopping
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Get your orders delivered in record time</p>
            </div>
            <div className="text-center">
